...
![SSH Threat Hunting Dashboard](evidence/ssh-threat-hunting-dashboard.png)
...
![SSH Authentication Events Table](evidence/ssh-authentication-events-table.png)
...
![SSH Multiple Password Failures](evidence/ssh-multiple-password-failures-details.png)
![SSH Multiple Password Failures Extended](evidence/ssh-multiple-password-failures-extended.png)
...
![SSH PAM Authentication Failure](evidence/ssh-pam-authentication-failure-details.png)
![SSH PAM Authentication Failure Extended](evidence/ssh-pam-authentication-failure-extended.png)
